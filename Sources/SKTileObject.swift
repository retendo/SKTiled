...
public class SKTileObject: SKShapeNode, SKTiledObject {
     ...
     */
    public func setColor(color color: SKColor, withAlpha alpha: CGFloat=0.35) {
    ...
    /**
     ...
     - parameter alpha: `CGFloat` alpha component for fill.
     */
    public func setColor(hexString hexString: String, withAlpha alpha: CGFloat=0.35) {
        ...
        if let vertices = getVertices() {
            ...
            case .ellipse:
                ...
                for (index, point) in vertsInverted.enumerate() {
                    ...
                    bezPoints.append(lerp(point, end: vertsInverted[nextIndex], t: 0.5))
                }
                ...
                if layer.orientation == .isometric {
                    ...
                    controlShape.strokeColor = self.strokeColor.colorWithAlphaComponent(0.2)
...
extension SKTileObject {
    override public var hashValue: Int { return id.hashValue }    
    override public var description: String {
        let objectName: String = name != nil ? "\"\(name!)\"" : "(null)"
        return "\(String(objectType).capitalizedString) Object: \(objectName), id: \(self.id)"
    }
